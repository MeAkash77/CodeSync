...
import {
  ...
  resizeBounds,
} from "@/src/lib/whiteboard_utils";
import SelectionBox from "@/src/components/whiteboard-components/SelectionBox";
import { nanoid } from "nanoid";
import LayerComponent from "@/src/components/whiteboard-components/LayerComponent";
import SelectionTools from "@/src/components/whiteboard-components/SelectionTools";
import useDisableScrollBounce from "@/src/hooks/useDisableScrollBounce";
import useDeleteLayers from "@/src/hooks/useDeleteLayers";
import MultiplayerGuides from "@/src/components/whiteboard-components/MultiplayerGuides";
import Path from "@/src/components/whiteboard-components/Path";
import ToolsBar from "@/src/components/whiteboard-components/ToolsBar";
import {
  useStorage,
  useSelf,
  useOthersMapped,
          ...
          >
            ...
            {canvasState.mode === CanvasMode.SelectionNet &&
              canvasState.current != null && (
                <rect
                  className="fill-blue-400/10 stroke-blue-500 stroke-[1px]"
